...
public class CustomerProductService {
	...
	public ResponseEntity<ResponseStructure<CustomerProductResponse>> deleteCustomerProduct(long customerProductId) {
		Optional<CustomerProduct> optionalCustomerProduct = customerProductDao.getCustomerProductById(customerProductId);
		if(optionalCustomerProduct.isPresent()) {
			...
			responseStructure.setMessage("Product deleted from CustomerProduct priority - "+customerProduct.getPriority()+" !!");
			responseStructure.setData(customerProductResponse);
